...
export const residentApp = [
    {
        id: 1,
        question: 'How does the online groceries shopping service work?',
        answer: "It's simple: just select the products you need, add them to your cart, place your order, and our dedicated Estility Rider will ensure your order is processed and delivered to your doorstep within 45 minutes. Convenience at your fingertips!",
    },

    {
        id: 2,
        question: 'What are the benefits of using Estility for cooking gas delivery?',
        answer: 'At Estility, we take pride in offering the best prices, timely delivery, and a guarantee of both quantity and quality. Your satisfaction is our commitment.',
    },

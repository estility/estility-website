  ...
  return (
    <nav className="nav plain-background">
      ...
      {isMenuVisible ? <FaTimes className="close-menu" onClick={toggleMenu} /> : null}
        ...
        <NavLink onClick={() =>setIsMenuVisible(false)} className='rosario-font' to="/">Home</NavLink>
        <NavLink onClick={() =>setIsMenuVisible(false)} className='rosario-font' to="/about-us">About Us</NavLink>
        <NavLink onClick={() =>setIsMenuVisible(false)} className='rosario-font' to="/products">Products</NavLink>
        <NavLink onClick={() =>setIsMenuVisible(false)} className='rosario-font' to="/vendors">Vendors</NavLink>
        <NavLink onClick={() =>setIsMenuVisible(false)} className='rosario-font' to="/contact">Contact</NavLink>
